...
task :isolate, :filename do |t, args|
  ...
  stash_dir = "#{configuration[:source]}/#{configuration[:stash_dir]}"
...
task :pingomatic do
  begin
    ...
    XMLRPC::Client.new('rpc.pingomatic.com', '/').call('weblogUpdates.extendedPing', 'franklinchen.com' , 'http://franklinchen.com', 'http://franklinchen.com/atom.xml')
  rescue LoadError
...
task :sitemapgoogle do
  begin
    ...
    Net::HTTP.get('www.google.com', '/webmasters/tools/ping?sitemap=' + URI.escape('http://franklinchen.com//sitemap.xml'))
  rescue LoadError
...
task :sitemapbing do
  begin
    ...
    Net::HTTP.get('www.bing.com', '/webmaster/ping.aspx?siteMap=' + URI.escape('http://franklinchen.com/sitemap.xml'))
  rescue LoadError
